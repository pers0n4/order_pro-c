...
CREATE SEQUENCE users_seq START WITH 0 INCREMENT BY 1 MINVALUE 0 MAXVALUE 99999999 NOCYCLE NOCACHE;
CREATE TABLE users
(
...
CREATE SEQUENCE shops_seq START WITH 0 INCREMENT BY 1 MINVALUE 0 MAXVALUE 99999999 NOCYCLE NOCACHE;
CREATE TABLE shops
(
...
CREATE SEQUENCE menus_seq START WITH 0 INCREMENT BY 1 MINVALUE 0 MAXVALUE 99999999 NOCYCLE NOCACHE;
CREATE TABLE menus
(
...
CREATE SEQUENCE orders_seq START WITH 0 INCREMENT BY 1 MINVALUE 0 MAXVALUE 99999999 NOCYCLE NOCACHE;
CREATE TABLE orders
(
...
CREATE SEQUENCE order_lines_seq START WITH 0 INCREMENT BY 1 MINVALUE 0 MAXVALUE 99999999 NOCYCLE NOCACHE;
...
CREATE SEQUENCE reviews_seq START WITH 0 INCREMENT BY 1 MINVALUE 0 MAXVALUE 99999999 NOCYCLE NOCACHE;
